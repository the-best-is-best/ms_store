...
class RepositoryImplLoginBySocial {
  static Future<Either<Failure, UserModel>> call(RemoteDataSrc remoteDataSrc,
      NetworkInfo networkInfo, LoginBySocialRequests loginRequests) async {
    if (await networkInfo.isConnected) {
      try {
        var response = await remoteDataSrc.loginBySocial(loginRequests);
