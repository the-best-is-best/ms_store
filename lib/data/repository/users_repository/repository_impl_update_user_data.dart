...
class RepositoryImplUpdateUserData {
  static Future<Either<Failure, bool>> call(RemoteDataSrc remoteDataSrc,
      NetworkInfo networkInfo, UpdateUserRequests updateUserRequests) async {
    if (await networkInfo.isConnected) {
      try {
        var response = await remoteDataSrc.updateUserData(updateUserRequests);
