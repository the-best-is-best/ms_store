...
class RepositoryImplDeleteUser {
  static Future<Either<Failure, bool>> call(RemoteDataSrc remoteDataSrc,
      NetworkInfo networkInfo, DeleteUserRequests deleteUserRequests) async {
    if (await networkInfo.isConnected) {
      try {
        var response = await remoteDataSrc.deleteUser(deleteUserRequests);
